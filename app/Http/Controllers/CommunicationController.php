...
class CommunicationController extends Controller
{
    ...
    //tatol
        ...
        $bible = Report::whereBetween('created_at', array($from, $to))
            ->sum('row1');
        $seven = Report::whereBetween('created_at', array($from, $to))
            ->sum('row2');
        $worship = Report::whereBetween('created_at', array($from, $to))
            ->sum('row3');
        $prophet = Report::whereBetween('created_at', array($from, $to))
            ->sum('row4');
        $signs = Report::whereBetween('created_at', array($from, $to))
            ->sum('row5');
        $hope = Report::whereBetween('created_at', array($from, $to))
            ->sum('row6');
    //2nd quater
    ...
    //4th quater
        ...
        $hope4 = Report::whereBetween('created_at', array($from4, $to4))
            ->sum('row6');
    //total
        $tbible = Report::whereBetween('created_at', array($tfrom, $tto))
            ->sum('row1');
        $tseven = Report::whereBetween('created_at', array($tfrom, $tto))
            ->sum('row2');
        $tworship = Report::whereBetween('created_at', array($tfrom, $tto))
            ->sum('row3');
        $tprophet = Report::whereBetween('created_at', array($tfrom, $tto))
            ->sum('row4');
        $tsigns = Report::whereBetween('created_at', array($tfrom, $tto))
            ->sum('row5');
        $thope = Report::whereBetween('created_at', array($tfrom, $tto))
            ->sum('row6');
